...
void test_astarte_storage_store_delete_cycle(void)
{
    ...
    TEST_ASSERT_EQUAL(ASTARTE_STORAGE_ERR_NOT_FOUND,
        astarte_storage_load_property(
            astarte_storage_handle, I1_P1_INAME, I1_P1_PNAME, NULL, &i1_p1_payload_read_len));

    TEST_ASSERT_EQUAL(ASTARTE_STORAGE_ERR_NOT_FOUND,
        astarte_storage_load_property(
            astarte_storage_handle, I1_P2_INAME, I1_P2_PNAME, NULL, &i1_p2_payload_read_len));

    TEST_ASSERT_EQUAL(ASTARTE_STORAGE_ERR_NOT_FOUND,
        astarte_storage_load_property(
            astarte_storage_handle, I2_P1_INAME, I2_P1_PNAME, NULL, &i2_p1_payload_read_len));

    TEST_ASSERT_EQUAL(ASTARTE_STORAGE_ERR_NOT_FOUND,
        astarte_storage_load_property(
            astarte_storage_handle, I2_P2_INAME, I2_P2_PNAME, NULL, &i2_p2_payload_read_len));

    // Store property
    TEST_ASSERT_EQUAL(ASTARTE_STORAGE_ERR_OK,
        astarte_storage_store_property(
            astarte_storage_handle, I1_P1_INAME, I1_P1_PNAME, i1_p1_payload, I1_P1_PAYLOAD_LEN));
    TEST_ASSERT_EQUAL(ASTARTE_STORAGE_ERR_OK,
        astarte_storage_store_property(
            astarte_storage_handle, I1_P2_INAME, I1_P2_PNAME, i1_p2_payload, I1_P2_PAYLOAD_LEN));
    TEST_ASSERT_EQUAL(ASTARTE_STORAGE_ERR_OK,
        astarte_storage_store_property(
            astarte_storage_handle, I2_P1_INAME, I2_P1_PNAME, i2_p1_payload, I2_P1_PAYLOAD_LEN));
    ...
    TEST_ASSERT_EQUAL(ASTARTE_STORAGE_ERR_OK,
        astarte_storage_load_property(astarte_storage_handle, I1_P1_INAME, I1_P1_PNAME,
    ...
    TEST_ASSERT_EQUAL(ASTARTE_STORAGE_ERR_OK,
        astarte_storage_load_property(astarte_storage_handle, I1_P2_INAME, I1_P2_PNAME,
    ...
    TEST_ASSERT_EQUAL(ASTARTE_STORAGE_ERR_OK,
        astarte_storage_load_property(astarte_storage_handle, I2_P1_INAME, I2_P1_PNAME,
...
void test_astarte_storage_store_null_deletes(void)
{
    ...
    TEST_ASSERT_EQUAL(ASTARTE_STORAGE_ERR_OK,
        astarte_storage_store_property(astarte_storage_handle, I1_P1_INAME, I1_P1_PNAME, NULL, 0));
...
void test_astarte_storage_contains(void)
{
    ...
    TEST_ASSERT_EQUAL(ASTARTE_STORAGE_ERR_OK,
        astarte_storage_contains_property(astarte_storage_handle, I1_P1_INAME, I1_P1_PNAME,
    ...
    TEST_ASSERT_EQUAL(ASTARTE_STORAGE_ERR_OK,
        astarte_storage_contains_property(astarte_storage_handle, I1_P2_INAME, I1_P2_PNAME,
            i1_p2_payload, I1_P2_PAYLOAD_LEN, &result));
    TEST_ASSERT_FALSE(result);

    // Store property with different content
    TEST_ASSERT_EQUAL(ASTARTE_STORAGE_ERR_OK,
        astarte_storage_store_property(
            astarte_storage_handle, I1_P1_INAME, I1_P1_PNAME, i1_p2_payload, I1_P2_PAYLOAD_LEN));
    ...
    TEST_ASSERT_EQUAL(ASTARTE_STORAGE_ERR_OK,
        astarte_storage_store_property(
            astarte_storage_handle, I1_P1_INAME, I1_P1_PNAME, i2_p2_payload, I2_P2_PAYLOAD_LEN));
