...
void test_astarte_linked_list_is_empty(void)
{
    ...
    astarte_linked_list_item_t item_1
        = { .value = "string 1", .value_len = strlen("string 1") + 1 };
    astarte_linked_list_item_t item_2
        = { .value = "string 2", .value_len = strlen("string 2") + 1 };
...
void test_astarte_linked_list_find(void)
{
    ...
    TEST_ASSERT_FALSE(astarte_linked_list_find(&handle, item));

    astarte_linked_list_item_t item_1
        = { .value = "string 1", .value_len = strlen("string 1") + 1 };
    astarte_linked_list_item_t item_2
        = { .value = "string 2", .value_len = strlen("string 2") + 1 };
    astarte_linked_list_item_t item_3
        = { .value = "string 3", .value_len = strlen("string 3") + 1 };
    TEST_ASSERT_EQUAL(ASTARTE_OK, astarte_linked_list_append(&handle, item_1));
    TEST_ASSERT_EQUAL(ASTARTE_OK, astarte_linked_list_append(&handle, item_2));

    TEST_ASSERT_TRUE(astarte_linked_list_find(&handle, item_1));
    TEST_ASSERT_TRUE(astarte_linked_list_find(&handle, item_2));
    TEST_ASSERT_FALSE(astarte_linked_list_find(&handle, item_3));
...
void test_astarte_linked_list_iterator_replace(void)
{
    ...
    astarte_linked_list_item_t item_2
        = { .value = "string 2", .value_len = strlen("string 2") + 1 };
    astarte_linked_list_item_t item_2_substitute
        = { .value = "string 2 substitute", .value_len = strlen("string 2 substitute") + 1 };
    astarte_linked_list_item_t item_3
        = { .value = "string 3", .value_len = strlen("string 3") + 1 };
    TEST_ASSERT_EQUAL(ASTARTE_OK, astarte_linked_list_append(&handle, item_1));
    TEST_ASSERT_EQUAL(ASTARTE_OK, astarte_linked_list_append(&handle, item_2));
    ...
    astarte_linked_list_item_t ret_item_1, ret_item_2, ret_item_3;
    astarte_linked_list_iterator_get_item(&iterator, &ret_item_1);
    TEST_ASSERT_EQUAL_INT(item_1.value_len, ret_item_1.value_len);
    TEST_ASSERT_EQUAL_STRING(item_1.value, ret_item_1.value);

    TEST_ASSERT_EQUAL(ASTARTE_OK, astarte_linked_list_iterator_advance(&iterator));
    astarte_linked_list_iterator_get_item(&iterator, &ret_item_2);
    TEST_ASSERT_EQUAL_INT(item_2.value_len, ret_item_2.value_len);
    TEST_ASSERT_EQUAL_STRING(item_2.value, ret_item_2.value);
    ...
    TEST_ASSERT_EQUAL(ASTARTE_OK, astarte_linked_list_iterator_advance(&iterator));
    astarte_linked_list_iterator_get_item(&iterator, &ret_item_3);
    TEST_ASSERT_EQUAL_INT(item_3.value_len, ret_item_3.value_len);
    TEST_ASSERT_EQUAL_STRING(item_3.value, ret_item_3.value);
    ...
    TEST_ASSERT_EQUAL(ASTARTE_OK, astarte_linked_list_iterator_advance(&iterator));
    astarte_linked_list_iterator_get_item(&iterator, &ret_item_2);
    TEST_ASSERT_EQUAL_INT(item_2_substitute.value_len, ret_item_2.value_len);
    TEST_ASSERT_EQUAL_STRING(item_2_substitute.value, ret_item_2.value);
