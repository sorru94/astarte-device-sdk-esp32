...
{
    astarte_set_handle_t handle = astarte_set_init();
...
void test_astarte_set_add_pop(void)
{
    ...
    TEST_ASSERT_EQUAL(ASTARTE_OK, astarte_set_pop(&handle, &ret_element_1));
    TEST_ASSERT_EQUAL(ASTARTE_OK, astarte_set_pop(&handle, &ret_element_2));
    TEST_ASSERT_EQUAL(ASTARTE_ERR_NOT_FOUND, astarte_set_pop(&handle, &ret_element_3));
