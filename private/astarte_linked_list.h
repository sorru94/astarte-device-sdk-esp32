 ...
 * @param[in] item Element to append to the linked list
 ...
 *
 * @param[inout] handle Linked list handle
 * @param[out] item Tail item retrieved from the linked list
 * @return One of the follwing error codes:
 ...
 *
 * @param[in] handle Linked list handle
 * @param[in] item Item that will be searched
 ...
 * @param[out] item Element retrieved from the linked list
 */
 ...
 *
 * @note This function does not de-allocate the old item content.
 *
 * @param[inout] iterator Iterator to use for the operation
 * @param[in] item Element to sobstitute from the linked list
 */
